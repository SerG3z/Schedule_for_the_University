...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            TeacherDAO teacherDao = helper.getTeacherDAO();
    ...
    public Loader onCreateLoader(int id, Bundle args) {
        ...
        switch (id) {
            case LOADER_PERIOD_ALL_ID:
                loader = new OrmLiteQueryForAllLoader<Period, Integer>(this);
                break;
            case LOADER_TEACHER_QUERY_ID:
                loader = new OrmLitePreparedQueryLoader<Teacher, Integer>(this);
                try {
                    PreparedQuery<Teacher> query = helper.getTeacherDAO()
        ...
        switch (loader.getId()) {
            case LOADER_PERIOD_ALL_ID:
                ...
                ArrayAdapter<String> adapter
                        = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, periodsStr);
                ...
                if (teacher.size() != 0) {
                    ...
                    try {
                        if (t.getTeacherName().compareTo("Smoke W.") == 0) {
                            helper.getPeriodDAO().create(new Period("Math", t, "08:00-09:35",
                                    "Homework"));

                        } else if (t.getTeacherName().compareTo("Fuss O.") == 0) {
                            helper.getPeriodDAO().create(new Period("Physics", t, "11:40-13:15",
                                    "Lab 1"));
